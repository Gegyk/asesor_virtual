...
__all__ = [
    'SREAudioLevel', 'SPCS_DISABLED', 'DISPID_SRCERequestUI',
    'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_APP', 'SAFT8kHz16BitMono',
    'DISPID_SLWsCount', 'SPEI_END_INPUT_STREAM', 'SRESoundEnd',
    'SREInterference', 'SPAR_Unknown', 'DISPID_SPRules_NewEnum',
    'DISPID_SRRAudioFormat', 'DISPID_SVSRunningState',
    'SAFTADPCM_8kHzStereo', 'SP_VISEME_16', 'SDTReplacement',
    'DISPID_SGRSTsItem', 'eLEXTYPE_PRIVATE17', 'DISPID_SPAsCount',
    'SPXMLRESULTOPTIONS', 'DISPID_SLGenerationId',
    'SAFT48kHz8BitMono', 'SRARoot', 'DISPID_SVIsUISupported',
    'DISPIDSPTSI_SelectionLength', 'ISpRecognizer3', 'DISPID_SVSkip',
    'SPEI_RECOGNITION', 'ISpeechAudio', 'SGRSTTWildcard',
    'SAFT16kHz8BitStereo', 'SpeechRegistryLocalMachineRoot',
    'SPFM_OPEN_READWRITE', 'SpeechInterference',
    'SpeechAudioFormatGUIDWave', 'SGDSActive', 'SPPS_Function',
    'DISPID_SLPsItem', 'SPDATAKEYLOCATION',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'eLEXTYPE_VENDORLEXICON',
    'SPBO_AHEAD', 'SpPhoneticAlphabetConverter',
    'SAFT24kHz16BitStereo', 'DISPID_SRCState', 'ISpeechVoiceStatus',
    'SPSEMANTICERRORINFO', 'SVP_10', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRCEEnginePrivate', 'SPAR_Medium',
    'SAFTNonStandardFormat', 'SAFTText',
    'SWPUnknownWordUnpronounceable', 'SAFTGSM610_8kHzMono',
    'SPEI_MAX_SR', 'DISPID_SAStatus', 'SP_VISEME_13',
    'DISPID_SPEs_NewEnum', 'SPPHRASEREPLACEMENT',
    'SREFalseRecognition', 'SPEI_TTS_PRIVATE',
    'DISPID_SVGetAudioOutputs', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_MORPHOLOGY', 'SPWF_INPUT',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPAPhraseInfo',
    'SP_VISEME_10', 'SPWT_PRONUNCIATION', 'SDTProperty',
    'SpeechGrammarState', 'SAFTADPCM_44kHzMono', 'SPPS_RESERVED1',
    'DISPID_SPIGetText', 'DISPID_SPIEngineId',
    'SpeechRecognizerState', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_PRIVATE18', 'DISPID_SLWPronunciations',
    'DISPID_SVDisplayUI', 'SAFT32kHz8BitStereo',
    'DISPID_SPRuleChildren', 'DISPID_SDKGetlongValue', 'SPAR_High',
    'SVESentenceBoundary', 'DISPID_SRRDiscardResultInfo', 'SINoise',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRIsUISupported',
    'ISpeechPhraseProperties', 'SRTSMLTimeout', 'DISPID_SRRAudio',
    'DISPID_SPPConfidence', 'DISPID_SpeechPhraseElements',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPRulesItem',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechDictationTopicSpelling',
    'DISPID_SABIEventBias', 'SDKLCurrentUser', 'SVP_13',
    'DISPID_SLGetWords', 'DISPID_SpeechAudioBufferInfo',
    'SpeechEngineConfidence', 'SPFM_NUM_MODES',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPEDisplayAttributes',
    'SVP_6', 'DISPID_SPIStartTime', 'SPINTERFERENCE_TOOSLOW',
    'SP_VISEME_8', 'DISPID_SABufferNotifySize', 'SSFMCreate',
    'SRAImport', 'DISPID_SPRNumberOfElements', 'ISpEventSink',
    'SAFTExtendedAudioFormat', 'WAVEFORMATEX', 'DISPID_SVSpeakStream',
    'ISpeechLexiconPronunciations', 'SPAUDIOSTATUS', 'SVP_9',
    'SPINTERFERENCE_TOOLOUD', 'SpeechRecoContextState',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT32kHz16BitStereo',
    'SREHypothesis', 'SRADefaultToActive', 'SpeechDiscardType',
    'DISPID_SpeechRecognizer',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechGrammarRule', 'DISPID_SPACommit', 'SVP_1',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRCERecognizerStateChange',
    'ISpStreamFormatConverter', 'SpPhoneConverter',
    'eLEXTYPE_PRIVATE3', 'SPDKL_CurrentUser', 'ISpeechObjectToken',
    'DISPID_SVGetVoices', 'SpeechCategoryRecoProfiles',
    '_ISpeechVoiceEvents', 'SPPS_Noun', 'DISPID_SVSPhonemeId',
    'DISPID_SVSVisemeId', 'DISPID_SRGSetTextSelection',
    'SPWORDPRONUNCIATIONLIST', 'SVEEndInputStream',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRSetPropertyNumber',
    'SAFT22kHz16BitStereo', 'SPBO_TIME_UNITS', 'SpMMAudioIn',
    'SpeechCategoryAppLexicons', 'DISPID_SVSpeak', 'SECLowConfidence',
    'SpeechFormatType', 'DISPID_SpeechMemoryStream', 'DISPID_SPIRule',
    'ISpDataKey', 'SpStreamFormatConverter',
    'DISPID_SPAStartElementInResult', 'SPEI_SOUND_START',
    'DISPID_SPILanguageId', 'ISpVoice',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRAudioInputStream', 'SECFIgnoreWidth', 'SVF_None',
    'DISPID_SPERequiredConfidence', 'SPSEMANTICFORMAT',
    'ISpeechPhraseProperty', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechAudioStatus', 'SpeechAudioProperties',
    'eWORDTYPE_ADDED', 'DISPID_SASNonBlockingIO',
    'SDA_No_Trailing_Space', 'DISPID_SOTCId', 'DISPID_SPPsCount',
    'SVP_5', 'DISPID_SpeechRecoResult2', 'SpCustomStream',
    'DISPID_SRCreateRecoContext', 'DISPID_SVStatus',
    'DISPID_SpeechMMSysAudio', 'SPEI_SR_AUDIO_LEVEL', 'SPSLMA',
    'DISPID_SRGCmdLoadFromResource', 'SECNormalConfidence',
    'SPCONTEXTSTATE', 'SVEViseme', 'SpeechDisplayAttributes',
    'SAFT22kHz8BitStereo', 'DISPID_SLWType', 'DISPID_SOTsItem',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCCreateResultFromMemory',
    'SVEPhoneme', 'ISpeechAudioFormat', 'DISPID_SGRsDynamic',
    'DISPID_SRCVoicePurgeEvent', 'SVP_12', 'eLEXTYPE_RESERVED8',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechVoice',
    'SPEI_RESERVED2', 'SPLEXICONTYPE', 'DISPID_SPRuleParent',
    'SRERequestUI', 'SVSFPurgeBeforeSpeak', 'DISPID_SDKDeleteKey',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpeechGrammarRules', 'SGRSTTRule',
    'SASRun', 'SWTDeleted', 'LONG_PTR', 'DISPID_SRGState',
    'DISPID_SVPause', 'DISPID_SVEStreamEnd', 'DISPID_SVEBookmark',
    'SpeechLexiconType', 'SPSInterjection', 'SpeechRecognitionType',
    'eLEXTYPE_RESERVED9', 'SpeechCategoryAudioIn',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechAudio',
    'DISPID_SPRuleFirstElement', 'DISPID_SRGetPropertyString',
    'SRSInactiveWithPurge', 'SRERecoOtherContext',
    'DISPID_SLAddPronunciation', 'SVP_20', 'DISPID_SPIGrammarId',
    'SAFT8kHz8BitStereo', 'SP_VISEME_11', 'SVEVoiceChange',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRSCurrentStreamPosition',
    'SITooSlow', 'SVPNormal', 'DISPID_SRGDictationLoad',
    'ISpNotifySink', 'DISPID_SRRGetXMLErrorInfo', 'SPGRAMMARSTATE',
    'DISPID_SGRsAdd', 'SpeechPartOfSpeech', 'SPSERIALIZEDPHRASE',
    'SVP_16', 'ISpRecoGrammar2', 'DISPID_SDKSetLongValue',
    'DISPID_SOTCreateInstance', 'SAFTGSM610_44kHzMono',
    'SpAudioFormat', 'SpeechAddRemoveWord', 'DISPID_SLPPhoneIds',
    'SPSMF_SAPI_PROPERTIES', 'STCRemoteServer', 'SPGRAMMARWORDTYPE',
    'SPINTERFERENCE_NONE', 'SpeechStreamSeekPositionType',
    'SpeechCategoryRecognizers', 'DISPID_SVEWord', 'SITooQuiet',
    'DISPID_SRSAudioStatus', 'DISPID_SOTRemove', 'SPGS_EXCLUSIVE',
    'DISPID_SVSLastResult', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechAudioState', 'SpeechTokenKeyUI',
    'DISPID_SGRSTPropertyName', 'DISPID_SPRuleId', 'SPRS_INACTIVE',
    'SASPause', 'DISPID_SGRsFindRule', 'SP_VISEME_4',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechAllElements',
    'ISpRecoContext', 'SAFT11kHz16BitMono', 'SPFM_OPEN_READONLY',
    'DISPID_SDKEnumValues', 'SGRSTTEpsilon',
    'DISPID_SOTCEnumerateTokens', 'SPPS_Verb',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SWPUnknownWordPronounceable', 'SDTAll', 'DISPID_SPPId',
    'DISPID_SpeechObjectToken', 'ISpAudio', 'DISPID_SPRsItem',
    'SPPS_Noncontent', 'SREPrivate', 'DISPID_SDKCreateKey',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCRetainedAudio',
    'SPPARTOFSPEECH', 'DISPID_SpeechPhraseProperty', 'SpVoice',
    'DISPID_SGRAddState', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRRPhraseInfo', 'DISPID_SVResume', 'ISpNotifyTranslator',
    'DISPID_SGRSTWeight', 'SVP_17',
    'DISPID_SVSLastStreamNumberQueued', 'SREBookmark',
    'DISPID_SpeechVoiceStatus', 'SAFT48kHz16BitMono',
    'SPDKL_CurrentConfig', 'DISPID_SpeechFileStream',
    'DISPID_SRProfile', 'SVP_14', 'SpeechPropertyResourceUsage',
    'SPAS_STOP', 'DISPID_SVWaitUntilDone', 'DISPID_SpeechPhraseRule',
    'DISPID_SLWs_NewEnum', 'DISPID_SGRSTType', 'ISpeechBaseStream',
    'DISPID_SPEAudioStreamOffset', 'SAFT44kHz8BitMono',
    'DISPID_SRCPause', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechLexiconWord', 'SAFT44kHz16BitStereo',
    'SPLO_DYNAMIC', 'ISpeechCustomStream',
    'DISPID_SVSyncronousSpeakTimeout', 'SpMMAudioOut',
    'SpSharedRecognizer', 'SAFTDefault', 'ISpeechFileStream',
    'DISPIDSPTSI', 'ISpeechRecoGrammar', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechLexicon', 'SGDSActiveWithAutoPause',
    'SpeechRunState', 'SAFTADPCM_44kHzStereo', 'DISPID_SFSOpen',
    'DISPID_SPRuleConfidence', 'SpeechGrammarRuleStateTransitionType',
    'SRTReSent', 'SP_VISEME_17', 'eLEXTYPE_PRIVATE14',
    'SpSharedRecoContext', 'eLEXTYPE_RESERVED4', 'SAFT32kHz8BitMono',
    'SPCS_ENABLED', 'SVEBookmark', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SGRSTPropertyValue',
    'SpPhraseInfoBuilder', 'eLEXTYPE_PRIVATE9', 'SPBINARYGRAMMAR',
    'eLEXTYPE_PRIVATE6', 'SPSHT_EMAIL', 'SP_VISEME_15',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SGDSInactive',
    'SVF_Emphasis', 'SPPS_LMA', 'SpeechVoiceEvents',
    'SPINTERFERENCE_NOSIGNAL', 'eLEXTYPE_PRIVATE4',
    'SPCT_SUB_COMMAND', 'SVP_0', 'SP_VISEME_6', 'SPGS_DISABLED',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRSAddWordTransition',
    'ISpObjectToken', 'SPPHRASERULE', 'DISPID_SDKGetBinaryValue',
    'SAFT48kHz16BitStereo', '_SPAUDIOSTATE', 'SRSActive',
    'SPBOOKMARKOPTIONS', 'SpeechEngineProperties',
    'ISpeechObjectTokens', 'DISPID_SPEsCount', 'SPWAVEFORMATTYPE',
    'DISPID_SpeechGrammarRules', 'SPEI_RESERVED1',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SOTGetAttribute',
    'DISPID_SPRText', 'eLEXTYPE_LETTERTOSOUND', 'ISpResourceManager',
    'SVP_4', 'SAFT22kHz16BitMono', 'tagSTATSTG', 'SVSFParseSsml',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVRate', 'SPPHRASEELEMENT',
    'DISPID_SLPSymbolic', 'ISpXMLRecoResult', 'SPPS_NotOverriden',
    'DISPID_SPIElements', 'SpeechTokenValueCLSID', 'SBOPause',
    'DISPID_SRGetFormat', 'DISPID_SPCIdToPhone', 'DISPID_SVEPhoneme',
    'SPSNoun', 'DISPID_SRCEEndStream', 'SVSFDefault',
    'DISPID_SRCESoundStart', 'DISPID_SRCEPropertyStringChange',
    'STCAll', 'SAFTCCITT_uLaw_44kHzStereo', 'ISpProperties',
    'DISPID_SRRTTickCount', 'SpeechStreamFileMode',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPEAudioSizeTime',
    'ISpeechPhraseAlternates', 'SPEI_RESERVED3', 'SPSVerb',
    'SPRECOSTATE', 'SAFT16kHz16BitMono', 'SAFT8kHz16BitStereo',
    'SPVPRI_ALERT', 'DISPID_SMSGetData', 'SP_VISEME_2',
    'SREPropertyNumChange', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpObjectTokenCategory', 'SPAUDIOOPTIONS',
    'SAFT12kHz16BitStereo', 'STSF_CommonAppData', 'SPEI_ADAPTATION',
    'Speech_Default_Weight', 'DISPID_SPPNumberOfElements',
    'SPSNotOverriden', 'DISPID_SVESentenceBoundary',
    'DISPID_SRRGetXMLResult', 'SPEI_HYPOTHESIS',
    'ISpeechXMLRecoResult', 'SECFDefault', 'SDTPronunciation',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechPhraseRules',
    'ISpeechPhraseInfo', 'eLEXTYPE_PRIVATE5', 'SRTStandard',
    'DISPID_SVVoice', 'DISPID_SRCCmdMaxAlternates', 'SDTDisplayText',
    'DISPID_SVEAudioLevel', 'Speech_Max_Word_Length',
    'DISPID_SRRSetTextFeedback', 'SPBO_PAUSE',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SASState',
    'tagSPPROPERTYINFO', 'SAFT44kHz8BitStereo', 'DISPID_SRGCommit',
    'DISPID_SpeechGrammarRule', 'DISPID_SRIsShared',
    'DISPID_SPPEngineConfidence', 'SPAUDIOSTATE', 'SGSExclusive',
    'DISPID_SPELexicalForm', 'DISPID_SRSClsidEngine',
    'DISPID_SAFSetWaveFormatEx', 'SPSFunction', 'SPRECOCONTEXTSTATUS',
    'SPWT_LEXICAL', 'SVSFIsXML', 'SAFT24kHz8BitStereo',
    'Speech_StreamPos_Asap', 'SAFT12kHz8BitMono', 'SPWT_DISPLAY',
    'DISPID_SASetState', 'DISPID_SPPValue',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRInitialState',
    'ISpeechPhraseRules', 'SDTAlternates', 'SPFM_CREATE_ALWAYS',
    'SECFEmulateResult', 'DISPID_SPEAudioTimeOffset',
    'SPPS_Interjection', 'SDKLDefaultLocation', 'SRCS_Disabled',
    'DISPID_SRCERecognition', 'SVEWordBoundary',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SOTCategory', 'SVP_11', 'SVSFParseMask',
    'DISPID_SRGRules', 'DISPID_SASFreeBufferSpace',
    'SpeechVoiceCategoryTTSRate', 'SpObjectToken', 'STSF_FlagCreate',
    'SGDisplay', 'SpMemoryStream', 'SpeechVoicePriority',
    'DISPID_SVSInputWordLength', 'SpeechRecoEvents',
    'eLEXTYPE_RESERVED7', 'DISPID_SLPLangId', 'DISPID_SGRAddResource',
    'DISPID_SRRAlternates', 'SGLexicalNoSpecialChars', 'SPEVENT',
    'SLOStatic', 'SPVISEMES', 'SPEI_FALSE_RECOGNITION', 'DISPIDSPRG',
    'SPVPRI_NORMAL', 'DISPID_SVGetAudioInputs', 'SPEI_MAX_TTS',
    'SPEI_SR_PRIVATE', 'DISPID_SRCRetainedAudioFormat',
    'SpObjectTokenCategory', 'DISPID_SRGDictationUnload',
    'DISPID_SOTDisplayUI', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SREmulateRecognition', 'SPEVENTSOURCEINFO',
    'DISPID_SVSLastBookmark', 'SpeechEmulationCompareFlags',
    'SDTRule', 'SVEStartInputStream', 'DISPID_SBSRead',
    'DISPID_SpeechCustomStream', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SOTIsUISupported',
    'DISPID_SRCEPhraseStart', 'ISpeechLexiconWords',
    'DISPID_SpeechVoice', 'DISPID_SPPs_NewEnum',
    'SpeechVoiceSkipTypeSentence', 'SPRST_ACTIVE',
    'DISPID_SLPPartOfSpeech', 'SpeechCategoryVoices', 'SpShortcut',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SVAudioOutput', 'ISpStreamFormat', 'SPEVENTENUM',
    'SP_VISEME_12', 'SpeechUserTraining', 'SpMMAudioEnum',
    'SPRST_ACTIVE_ALWAYS', 'ISpObjectWithToken',
    'DISPID_SRCEAudioLevel', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRCBookmark', 'SP_VISEME_14', 'eWORDTYPE_DELETED',
    'SpeechRuleAttributes', 'DISPID_SPRs_NewEnum',
    'ISpeechAudioBufferInfo', 'SpeechPropertyComplexResponseSpeed',
    'SGDSActiveUserDelimited', 'IInternetSecurityMgrSite', 'SVP_3',
    'SDTLexicalForm', 'SpeechVoiceSpeakFlags', 'SPEI_MIN_TTS',
    'DISPID_SRRRecoContext', 'SpResourceManager',
    'DISPIDSPTSI_ActiveLength', 'SECFIgnoreCase',
    'ISpeechGrammarRuleStateTransitions',
    'SPEI_PROPERTY_STRING_CHANGE', 'SECFIgnoreKanaType',
    'SpUnCompressedLexicon', 'SPEI_REQUEST_UI',
    'SpeechGrammarTagWildcard', 'DISPID_SOTDataKey',
    'SREPropertyStringChange', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVAudioOutputStream',
    'SPCT_SLEEP', 'DISPID_SVAlertBoundary', 'SPRULE', 'SSTTDictation',
    'SRADynamic', 'SAFT16kHz8BitMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'STCInprocServer', 'ISpeechAudioStatus',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpSerializeState',
    'SP_VISEME_0', 'DISPID_SpeechGrammarRuleStateTransition',
    'SAFTCCITT_ALaw_11kHzMono', 'SREStateChange',
    'ISpeechRecoContext', 'SPSModifier', 'SVEAudioLevel',
    'SRTAutopause', 'DISPID_SRGRecoContext', 'SPRST_NUM_STATES',
    'SPLOADOPTIONS', 'DISPID_SpeechAudioFormat', 'SSTTWildcard',
    'DISPID_SMSAMMHandle', 'SRAInterpreter', 'ISpRecoContext2',
    'DISPID_SBSFormat', 'SPAS_PAUSE', 'SGRSTTDictation',
    'DISPID_SRCESoundEnd', 'SpTextSelectionInformation',
    'eLEXTYPE_RESERVED6', 'SVSFIsFilename', 'SITooLoud',
    'SpeechBookmarkOptions', 'SAFTADPCM_8kHzMono',
    'SPRECORESULTTIMES', 'SRAORetainAudio', 'ISpPhraseAlt',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechPhraseInfo',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechCategoryAudioOut',
    'SPEI_SR_BOOKMARK', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechVoiceEvent', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SGRAttributes', 'DISPID_SPEActualConfidence',
    'ISpGrammarBuilder', 'DISPID_SRGetPropertyNumber',
    'SPCATEGORYTYPE', 'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE1',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechRecognizer', 'SBONone',
    'DISPID_SPRuleNumberOfElements', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechAudioFormatGUIDText', 'SPAUDIOBUFFERINFO', 'SLTApp',
    'ISpRecoGrammar', 'SAFTGSM610_22kHzMono', 'SPSERIALIZEDRESULT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVP_2',
    'DISPID_SVPriority', 'SRCS_Enabled', 'ISpeechResourceLoader',
    'SPEI_RECO_STATE_CHANGE', 'IStream', 'DISPID_SpeechPhraseElement',
    'tagSPTEXTSELECTIONINFO', 'SpeechVisemeFeature',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPRulesCount',
    'IInternetSecurityManager', 'DISPID_SRRecognizer',
    'DISPID_SRCResume', 'SpeechPropertyNormalConfidenceThreshold',
    'SPWF_SRENGINE', 'DISPID_SPIAudioSizeTime', 'DISPID_SOTId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT48kHz8BitStereo', 'DISPID_SRGIsPronounceable',
    'DISPID_SVEEnginePrivate', 'DISPID_SRRSpeakAudio',
    'DISPID_SPPFirstElement', 'ISpPhoneticAlphabetConverter',
    'SRTEmulated', 'DISPID_SDKEnumKeys', 'DISPID_SMSSetData',
    'SLTUser', 'eLEXTYPE_RESERVED10', 'DISPID_SRSNumberOfActiveRules',
    'SPEI_PHRASE_START', 'eLEXTYPE_PRIVATE20',
    'Speech_StreamPos_RealTime', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_PRIVATE15', 'SpCompressedLexicon',
    'DISPID_SABIMinNotification', 'DISPID_SVGetProfiles',
    'SGSDisabled', 'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE12',
    'SPEI_START_SR_STREAM', 'SpeechLoadOption', 'ISpPhrase',
    'SECFNoSpecialChars', 'DISPID_SGRClear',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCEBookmark',
    '__MIDL_IWinTypes_0009', 'DISPID_SWFEBlockAlign',
    'SPTEXTSELECTIONINFO', 'SpInProcRecoContext', 'DISPID_SPPsItem',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechDataKey',
    'SPEI_VOICE_CHANGE', 'DISPID_SVEStreamStart', 'SVEPrivate',
    'eLEXTYPE_USER_SHORTCUT', 'SSFMOpenForRead',
    'ISpeechRecognizerStatus', 'ISpeechRecoResult2',
    'ISpNotifySource', 'DISPID_SVSLastBookmarkId', 'SPAR_Low',
    'SpeechVisemeType', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRAudioInput', 'SPSSuppressWord', 'SRESoundStart',
    'SPSMF_UPS', 'ISpRecognizer2', 'DISPID_SAFType',
    'SpInprocRecognizer', 'SPINTERFERENCE_TOOQUIET', 'SVP_19',
    '_RemotableHandle', 'SVSFPersistXML', 'ISpeechPhraseReplacements',
    'SPEI_PHONEME', 'ISpRecognizer', 'ISpeechPhraseElements',
    'DISPID_SVVolume', 'SPEI_INTERFERENCE',
    'SpeechCategoryPhoneConverters', 'SPEI_RESERVED5',
    'SPSHT_NotOverriden', 'SVP_15', 'SP_VISEME_9',
    'SAFT22kHz8BitMono', 'SPINTERFERENCE', 'SPPS_Unknown',
    'DISPID_SOTSetId', 'DISPID_SGRSRule',
    'SDA_Consume_Leading_Spaces', 'DISPID_SMSALineId', 'SASStop',
    'DISPID_SRRTLength', 'DISPID_SLWWord', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGSetWordSequenceData',
    'SPEI_UNDEFINED', 'DISPID_SpeechLexiconWords', 'DISPID_SRCVoice',
    'SpeechRecoProfileProperties', 'SLODynamic', 'DISPID_SBSSeek',
    'ISpMMSysAudio', 'DISPID_SRDisplayUI', 'DISPID_SOTsCount',
    'DISPID_SPEEngineConfidence', 'ISpeechPhoneConverter',
    'SPBO_NONE', 'SPPHRASEPROPERTY', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SOTCGetDataKey', 'SPRST_INACTIVE', 'SREPhraseStart',
    'SRSInactive', 'SpeechPropertyAdaptationOn', 'DISPID_SLPType',
    'ISpeechObjectTokenCategory', 'ISpeechGrammarRuleState',
    'DISPID_SVSInputWordPosition',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPCLangId',
    'DISPID_SMSADeviceId', 'SAFTADPCM_11kHzMono',
    'DISPID_SVEVoiceChange', 'DISPID_SPIAudioStreamPosition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSUnknown',
    'SpWaveFormatEx', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SWFEFormatTag', 'UINT_PTR', 'SASClosed',
    'ISpeechRecoResult', 'SITooFast',
    'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SpeechBaseStream',
    'DISPID_SRCEStartStream', 'SREAdaptation', 'SPVOICESTATUS',
    'ISpeechWaveFormatEx', 'SRATopLevel', 'STSF_AppData',
    'SP_VISEME_7', 'DISPID_SABIBufferSize', 'DISPID_SPARecoResult',
    'SPFILEMODE', 'SpeechTokenKeyFiles', 'DISPID_SGRsCount',
    'SRAExport', 'SSSPTRelativeToEnd', 'SGPronounciation',
    'eLEXTYPE_PRIVATE13', 'STCLocalServer',
    'ISpeechPhraseInfoBuilder', 'SPWORDPRONOUNCEABLE', 'SPVPRIORITY',
    'SAFT11kHz8BitStereo', 'eLEXTYPE_USER',
    'DISPID_SDKGetStringValue', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRCEventInterests', 'IEnumSpObjectTokens',
    'DISPID_SWFEChannels', 'SREStreamEnd',
    'DISPID_SPERetainedSizeBytes', 'SpFileStream', 'DISPID_SPPName',
    'ISpeechDataKey', 'DISPID_SAEventHandle', 'SPPS_RESERVED3',
    'eLEXTYPE_PRIVATE8', 'SINoSignal', 'SPSHORTCUTTYPE',
    'DISPID_SCSBaseStream', 'SRSActiveAlways', 'SP_VISEME_20',
    'SDKLLocalMachine', 'DISPID_SLGetGenerationChange', 'SVP_21',
    'SP_VISEME_3', 'SpeechMicTraining',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechLexiconWord',
    'DISPID_SRGReset', 'DISPID_SBSWrite', 'ISpeechMMSysAudio',
    'SPEI_SENTENCE_BOUNDARY', 'SPPS_RESERVED4', 'ISpStream',
    'SP_VISEME_19', 'DISPID_SGRs_NewEnum', 'SpStream',
    'DISPID_SGRSTransitions', 'SPXRO_Alternates_SML',
    'DISPID_SRCEAdaptation', 'DISPID_SRCRequestedUIType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPVPRI_OVER',
    'DISPID_SGRId', 'SVSFNLPMask', 'DISPID_SRCSetAdaptationData',
    'DISPID_SGRSTRule', 'DISPID_SGRsCommit', 'SPWORD',
    'DISPID_SpeechRecoResult', 'SAFTNoAssignedFormat',
    'DISPID_SPIProperties', 'SpeechPropertyResponseSpeed',
    'SAFT32kHz16BitMono', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechRecoContextEvents', 'SpLexicon', 'SPPHRASE',
    'SDKLCurrentConfig', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SDKDeleteValue',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechPhraseReplacement',
    'SVP_18', 'ISpeechTextSelectionInformation', 'SVPOver',
    'DISPID_SOTMatchesAttributes', 'DISPID_SGRSTs_NewEnum',
    'SSTTTextBuffer', 'ISpPhoneConverter', 'DISPID_SGRName',
    '_ISpeechRecoContextEvents', 'DISPID_SRCCreateGrammar',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SGRSTNextState', 'SRSEDone', 'DISPID_SLPsCount',
    'SP_VISEME_21', 'SAFTADPCM_11kHzStereo', 'SVSFParseAutodetect',
    'SSFMOpenReadWrite', 'SPRULESTATE', 'DISPID_SPRDisplayAttributes',
    'SSSPTRelativeToStart', 'ISpeechRecoResultTimes',
    'SAFTADPCM_22kHzMono', 'DISPID_SDKSetStringValue',
    'SRTExtendableParse', 'DISPID_SPIAudioSizeBytes',
    'ISpeechPhraseElement', 'DISPID_SFSClose',
    'DISPID_SpeechPhraseProperties', 'SPEI_PROPERTY_NUM_CHANGE',
    'ISpeechPhraseReplacement', 'DISPID_SWFEExtraData', 'SPWORDTYPE',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRGCmdSetRuleState', 'SAFT24kHz16BitMono',
    'SpNotifyTranslator', 'ISequentialStream', 'DISPID_SRRTimes',
    'SpeechSpecialTransitionType', 'DISPID_SPIReplacements',
    'ISpLexicon', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SOTGetDescription',
    'SpeechAudioVolume', 'SVSFUnusedFlags',
    'SpeechTokenIdUserLexicon', 'SAFT44kHz16BitMono',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPEDisplayText', 'SP_VISEME_18',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPAs_NewEnum',
    'DISPID_SOTs_NewEnum', 'SPPS_RESERVED2',
    'ISpeechLexiconPronunciation', 'SVSFVoiceMask', 'SPEI_SOUND_END',
    'DISPID_SGRsCommitAndSave', 'DISPID_SADefaultFormat',
    'SVSFlagsAsync', 'SSFMCreateForWrite', 'SDA_Two_Trailing_Spaces',
    'SVEAllEvents', 'SFTSREngine', 'SGRSTTWord', 'DISPID_SPRsCount',
    'SDA_One_Trailing_Space', 'SPSHORTCUTPAIR',
    'SpNullPhoneConverter', 'DISPID_SRCEInterference',
    'DISPID_SRSetPropertyString', 'SPSTREAMFORMATTYPE',
    'DISPID_SLWLangId', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRCEFalseRecognition',
    'DISPID_SRCERecognitionForOtherContext',
    'SpeechWordPronounceable', 'SAFTGSM610_11kHzMono',
    'SPPS_SuppressWord', 'DISPID_SVSpeakCompleteEvent', 'SPRS_ACTIVE',
    'IEnumString', 'ISpRecoResult', 'DISPID_SRCRecognizer',
    'ISpeechPhraseRule', 'SPCT_SUB_DICTATION',
    'DISPID_SVEventInterests', 'SGLexical', 'ISpShortcut',
    'SPFM_CREATE', 'SpeechRuleState', 'DISPID_SOTCSetId',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRRTStreamTime',
    'DISPID_SRRSaveToMemory', 'SPXRO_SML', 'SRSEIsSpeaking',
    'DISPID_SGRsItem', 'SAFTCCITT_ALaw_8kHzMono',
    'SPRECOGNIZERSTATUS', 'DISPID_SRStatus',
    'DISPID_SPIEnginePrivateData', 'SVPAlert', 'SP_VISEME_5',
    'SRAONone', 'SDTAudio', 'DISPID_SPPParent', 'DISPID_SLWsItem',
    'DISPID_SDKOpenKey', 'SRERecognition',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SPRuleName',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPEsItem',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_TTS_BOOKMARK',
    'eLEXTYPE_PRIVATE11', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SDKSetBinaryValue',
    'SPINTERFERENCE_NOISE', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPRFirstElement', 'SpeechTokenContext', 'SPLO_STATIC',
    'SECHighConfidence', 'DISPID_SPPChildren', 'DISPID_SRState',
    'SPAO_NONE', 'SAFT16kHz16BitStereo', 'SpeechTokenShellFolder',
    'ISpeechRecoResultDispatch', 'SFTInput', 'SpeechRegistryUserRoot',
    'SpeechGrammarWordType', 'STCInprocHandler', 'SREStreamStart',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SLGetPronunciations', 'SpeechAudioFormatType',
    'DISPID_SABufferInfo', 'ISpRecoCategory', 'SVSFIsNotXML',
    'SAFT12kHz8BitStereo', 'SPWORDLIST', 'SGRSTTTextBuffer',
    'SAFT12kHz16BitMono', 'DISPID_SPCPhoneToId', 'SPGS_ENABLED',
    'DISPID_SpeechWaveFormatEx', 'ISpeechLexicon', 'SPSHT_OTHER',
    'SPEI_VISEME', 'SWTAdded', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPISaveToMemory', 'SPAO_RETAIN_AUDIO',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechRecoContext',
    'SVP_7', 'DISPID_SPAsItem', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPSHT_Unknown', 'SPSHORTCUTPAIRLIST', 'DISPID_SVEViseme',
    'SINone', 'SPPS_Modifier', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SGRSTText', 'SREAllEvents', 'ISpeechMemoryStream',
    'SAFT24kHz8BitMono', 'SWPKnownWordPronounceable',
    'SAFT8kHz8BitMono', 'SPDKL_LocalMachine', 'eLEXTYPE_PRIVATE19',
    'SGSEnabled', 'SPCT_DICTATION', 'SPEI_MIN_SR',
    'SpeechRetainedAudioOptions', 'SVSFNLPSpeakPunc',
    'DISPID_SVSInputSentenceLength', 'SVP_8',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SGRSTsCount',
    'STSF_LocalAppData', 'SAFT11kHz8BitMono', 'SP_VISEME_1',
    'DISPID_SRGId', 'SVSFParseSapi', 'SPDKL_DefaultLocation',
    'SPPROPERTYINFO', 'SPEI_RESERVED6', 'DISPID_SAFGuid',
    'ISpEventSource', 'ISpeechPhraseAlternate', 'DISPID_SLPs_NewEnum',
    'DISPID_SAVolume', 'SVF_Stressed', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SOTCDefault', 'SPCT_COMMAND', 'Speech_Max_Pron_Length',
    'SpeechDataKeyLocation', 'SPAS_CLOSED', 'SpeechWordType',
    'SPADAPTATIONRELEVANCE', 'SPAS_RUN', 'DISPID_SpeechObjectTokens',
    'SpeechTokenKeyAttributes', 'SAFTCCITT_uLaw_22kHzStereo'
]

_check_version('1.2.0', 1700003674.653241)
