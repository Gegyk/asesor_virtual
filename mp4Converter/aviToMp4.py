...
def batch_convert_to_mp4(input_folder, output_folder):
    ...
    for file in files:
        # Verificar si el archivo es un archivo de video AVI
...
input_folder = r"z:\TeraBoxDownload\Hora de aventuras\Tierras lejanas"
output_folder = r"z:\elbauldegegy\multimedia\series\HoraDeAventuras\Tierras lejanas"
